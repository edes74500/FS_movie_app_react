...
const SortContainer = ({ filterName, children, icon: Icon, onClickReset, onClickExpand, moreOptions }) => {
  ...
  return (
    <StyledGenreListFilter data-indentifier="GenreListFilter">
      <div className="filter-title-container">
        ...
        <span className="handle-list-open" onClick={closeList}>
          <span className="dropdown-icon">{Icon && <Icon onClick={onClickReset} />}</span>
        </span>
      </div>
      <div className="filter-content-container">{children}</div>
      {moreOptions && (
        <div className="moreOptionsWrapper" onClick={toogleListFilter}>
          <div className="more-content" onClick={onClickExpand}>
