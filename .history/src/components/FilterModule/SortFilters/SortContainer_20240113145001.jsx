...
const SortContainer = ({ filterName, children, resetOptions, userHasSelectedGenres, onClickReset, toogleExpand, moreOptions, functions }) => {
  ...
  return (
    <StyledGenreListFilter data-indentifier="GenreListFilter" $moreOptions={moreOptions} $listIsOpen={listIsOpen}>
      <div
        ...
        onClick={() => {
          functions.toogleListFilter();
          functions.toogleExpand();
        }}
      >
        <h3>
          <TbCategoryPlus />
