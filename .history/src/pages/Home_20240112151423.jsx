...
const ContainerWithFixedHeight = styled.div`
  height: 5000px; /* Définissez la hauteur que vous souhaitez ici */
  overflow: hidden; /* Vous pouvez ajouter un overflow hidden si nécessaire */
`;
const Home = () => {
    ...
    <>
     ...
     < ContainerWithFixedHeight>
      <StyledHomePage data-identifier="Home">
        ...
        </ ContainerWithFixedHeight></ContainerWithFixedHeight>
    </>
  );
};
