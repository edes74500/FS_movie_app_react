...
export const globalStyles = css`
  ...
  :root {
    ...
    --filter-selected-color: rgb(30, 144, 255); // Exemple de couleur secondaire
    --text-color-blue: rgb(143, 169, 191);
    --button-movie-color: rgb(143, 169, 191); //
    --filer-gategory-header-color: rgb(143, 169, 191);
    --item-category-color: #89858539; //
    --range-selected-color: rgb(143, 169, 191);
    --range-rail-color: rgb(191, 143, 143);
  }
