...
const globalStyles = css`
  ...
  :root {
    ...
    --item-category-color: #a2a19f36; //
    --item-category-text-color: #ffffff; //
    --filter-reset-button-color: rgb(0, 124, 249);
    --filter-selected-color: rgba(0, 111, 222, 0.234);
    --filter-hover-color: rgba(0, 111, 222, 1);
    /* --filter-selected-color: rgb(57, 112, 167); */
    --range-selected-color: rgb(130, 41, 94);
